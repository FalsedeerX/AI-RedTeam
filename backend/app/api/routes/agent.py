...
# ---------------------------------------------------------------------------
# In-memory mapping: run_id → project_id
# (So status/approve/deny/kill don't need project_id in the URL)
# ---------------------------------------------------------------------------

_run_project_map: dict[str, str] = {}
...
class AgentRouter:
    ...
    async def start_run(
        ...
        _run_project_map[run_id] = payload.project_id
    ...
    async def get_status(
        ...
        project_id = _run_project_map.get(run_id)
        if not project_id:
